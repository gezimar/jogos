...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            imagebutton:
                idle Text("Início")
                hover Text("Início", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),Start()]
                hovered Play("sound", "button_click_encostar.mp3")

        else:
            imagebutton:
                idle Text("Histórico")
                hover Text("Histórico", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),ShowMenu("history")]
                hovered Play("sound", "button_click_encostar.mp3")

            imagebutton:
                idle Text("Salvar")
                hover Text("Salvar", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),ShowMenu("save")]
                hovered Play("sound", "button_click_encostar.mp3")

        imagebutton:
                idle Text("Carga")
                hover Text("Carga", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),ShowMenu("load")]
                hovered Play("sound", "button_click_encostar.mp3")

        imagebutton:
                idle Text("Preferências")
                hover Text("Preferências", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),ShowMenu("preferences")]
                hovered Play("sound", "button_click_encostar.mp3")

        if _in_replay:
            imagebutton:
                idle Text("Fim da reprodução")
                hover Text("Fim da reprodução", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),EndReplay(confirm=True)]
                hovered Play("sound", "button_click_encostar.mp3")

        elif not main_menu:
            imagebutton:
                idle Text("Menu principal")
                hover Text("Menu principal", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),MainMenu()]
                hovered Play("sound", "button_click_encostar.mp3")

        imagebutton:
                idle Text("Sobre")
                hover Text("Sobre", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),ShowMenu("about")]
                hovered Play("sound", "button_click_encostar.mp3")
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            imagebutton:
                idle Text("Ajuda")
                hover Text("Ajuda", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),ShowMenu("help")]
                hovered Play("sound", "button_click_encostar.mp3")
        ...
        if renpy.variant("pc"):
            ...
            imagebutton:
                idle Text("Sair")
                hover Text("Sair", color="#c8c8ff")
                action [Play("sound", "button_click_menu.mp3"),Quit(confirm=not main_menu)]
                hovered Play("sound", "button_click_encostar.mp3")
...
screen about():
    ...
    use game_menu(_("Sobre"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Feito com {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only] .\n\n[renpy.license!t]\n\n O jogador que é parente da vítima de um cruel assassinato vai passar por desafios com alguns alunos em uma escola do ensino médio nos anos 80, tendo que interagir e terminar tarefas para descobrir pistas e se aproximar das pessoas a fim de poder desvendar o grande mistério:\nQuem é o verdadeiro assassino da Olívia?\n\nCréditos:\nDaniel Fenner: Artista de cenários e Co-roteirista.\nGezimar Pereira: Programador.\nMatheus Mendonça: Músico e artista.\nMilene Gomes: Artista dos personagens e roteirista.\nThomas Aleixo: produtor audiovisual e designer editorial")
